...
| `bundle exec fastlane android ui_test_artifacts profile:all` | Собирает универсальный APK для всех зафиксированных конфигураций. |
...
| `bundle exec fastlane android selectel_ui_tests profile:all` | Последовательно проверяет фиксированный каталог, освобождая аренды и разделяя отчёты. |
