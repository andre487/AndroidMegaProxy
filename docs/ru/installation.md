...
архитектуры и предназначен для независимой проверки воспроизводимой сборки в F-Droid.
...
в меню главного экрана выбрать **Проверить** перед первым подключением.
