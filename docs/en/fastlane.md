...
| `bundle exec fastlane android ui_test_artifacts profile:additional` | Builds APKs for the optional additional device configurations. |
...
| `bundle exec fastlane android selectel_ui_tests profile:additional` | Runs four additional configurations sequentially, excluding required Android 15. |
